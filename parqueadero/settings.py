...
SECRET_KEY = 'django-insecure-9nj$bh6a)zo*0=dynn2_yo@g6(ezkb3u79lvra0s6gh$*hxgu1'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'db_new_parqueadero',      # El nombre que pusiste en Workbench
        'USER': 'root',                # Tu usuario de MySQL (por defecto es root)
        'PASSWORD': 'root321*',   # La contraseña que usas para entrar a Workbench
